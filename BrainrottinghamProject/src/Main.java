...
import PrototypeFactory.SistemOperareFactory;
import PrototypeFactory.TipSistemOperare;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("------------------------------------------------------\n");
         ...
         //prorotype factory
        so3 = (SistemOperare) SistemOperareFactory.getSistemOperare(TipSistemOperare.versiuneDeBaza2);
        so3.print();

        SistemOperare sofactory1 = (SistemOperare) SistemOperareFactory.getSistemOperare(TipSistemOperare.versiuneDeBazaNuAmAvutInspiratie);
        sofactory1.print();
    }
}