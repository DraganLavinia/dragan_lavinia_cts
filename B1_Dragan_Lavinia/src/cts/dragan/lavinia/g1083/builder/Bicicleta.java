...
public class Bicicleta {
	...
	public Bicicleta(String corpBicicleta,String ghidon,String sa, String pedale,String roti) {
	...
	public String toString() {
		return "Bicicleta are corpul " + corpBicicleta + " cu ghidonul " + ghidon + " saua "
